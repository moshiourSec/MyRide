...
class UpdateService {
    ...
    // update users location on firebase
    ...
    // update drivers location on firebase
    ...
    func acceptTrip(withPassengerKey passengerKey: String, forDriverKey driverKey: String){
        ...
        DataService.instance.REF_TRIPS.child(driverKey).updateChildValues(["driverIsOnTrip": true])
    }
